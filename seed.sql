...
INSERT INTO clubs (id, affiliation_number, display_name, is_archived) VALUES
  ...
  ('club-etival', '06880123', 'Etival', 0),
  ('club-rosenau', '06680125', 'Rosenau', 0),
  ('club-rc-strasbourg', '06670045', 'RC Strasbourg', 0),
  ('club-vittel', '06880022', 'Vittel St Remy', 0),
  ('club-illzach', '06680091', 'Illzach', 0),
  ('club-moussey', '06100004', 'Moussey', 0),
  ('club-anould', '06880002', 'Anould', 0),
  ('club-colmar-mjc', '06680004', 'Colmar MJC', 0),
  ('club-colmar-aje', '06680080', 'Colmar AJE', 0),
  ('club-saint-louis', '06680082', 'Saint-Louis', 0),
  ('club-huningue', '06680102', 'Huningue', 0),
  ('club-ingersheim', '06680090', 'Ingersheim', 0),
  ('club-issenheim', '06680071', 'Issenheim', 0),
  ('club-wintzfelden', '06680116', 'Wintzfelden', 0),
  ('club-thann', '06680111', 'Thann', 0),
  ('club-soultz', '06680138', 'Soultz', 0),
  ('club-wittelsheim', '06680118', 'Wittelsheim', 0),
  ('club-fc-mulhouse', '06680006', 'FC Mulhouse', 0),
  ('club-kembs', '06680140', 'Kembs', 0),
  ('club-ensisheim', '06680123', 'Ensisheim TTMC', 0),
  ('club-ballons', '06880064', 'Ballons des Vosges', 0),
  ('club-mulhouse-tt', '06680105', 'Mulhouse TT', 0);
