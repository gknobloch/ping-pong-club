...
export const mockTeams: Team[] = [
  // PPA Rixheim teams
  {
    id: 'team-1', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 1, divisionId: 'div-1', groupId: 'group-1',
  ...
  {
    id: 'team-2', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 2, divisionId: 'div-2', groupId: 'group-2',
  ...
  {
    id: 'team-3', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 3, divisionId: 'div-3', groupId: 'group-3',
  ...
  {
    id: 'team-4', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 4, divisionId: 'div-4', groupId: 'group-4',
  ...
  {
    id: 'team-5', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 5, divisionId: 'div-5', groupId: 'group-5',
  ...
  {
    id: 'team-6', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 6, divisionId: 'div-5', groupId: 'group-5',
  ...
  {
    id: 'team-7', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 7, divisionId: 'div-6', groupId: 'group-6',
  ...
  {
    id: 'team-8', clubId: 'club-fftt-06680011', phaseId: 'phase-1', number: 8, divisionId: 'div-7', groupId: 'group-7',
  ...
  // Group 1-5 opponents
  oppTeam('opp-etival-1', 'club-fftt-06880123', 1, 'div-1', 'group-1'),
  oppTeam('opp-rosenau-1', 'club-fftt-06680125', 1, 'div-1', 'group-1'),
  oppTeam('opp-rcs-2', 'club-fftt-06670045', 2, 'div-1', 'group-1'),
  oppTeam('opp-vittel-1', 'club-fftt-06880022', 1, 'div-1', 'group-1'),
  oppTeam('opp-illzach-2', 'club-fftt-06680091', 2, 'div-1', 'group-1'),
  oppTeam('opp-moussey-1', 'club-fftt-06100004', 1, 'div-1', 'group-1'),
  oppTeam('opp-anould-2', 'club-fftt-06880002', 2, 'div-1', 'group-1'),
  oppTeam('opp-illzach-3', 'club-fftt-06680091', 3, 'div-2', 'group-2'),
  oppTeam('opp-rosenau-2', 'club-fftt-06680125', 2, 'div-2', 'group-2'),
  oppTeam('opp-cmjc-3', 'club-fftt-06680004', 3, 'div-2', 'group-2'),
  oppTeam('opp-caje-1', 'club-fftt-06680080', 1, 'div-2', 'group-2'),
  oppTeam('opp-stlouis-1', 'club-fftt-06680082', 1, 'div-2', 'group-2'),
  oppTeam('opp-huningue-1', 'club-fftt-06680102', 1, 'div-2', 'group-2'),
  oppTeam('opp-ingersheim-1', 'club-fftt-06680090', 1, 'div-2', 'group-2'),
  oppTeam('opp-issenheim-1', 'club-fftt-06680071', 1, 'div-3', 'group-3'),
  oppTeam('opp-illzach-6', 'club-fftt-06680091', 6, 'div-3', 'group-3'),
  oppTeam('opp-wintzfelden-2', 'club-fftt-06680116', 2, 'div-3', 'group-3'),
  oppTeam('opp-huningue-2', 'club-fftt-06680102', 2, 'div-3', 'group-3'),
  oppTeam('opp-thann-2', 'club-fftt-06680111', 2, 'div-3', 'group-3'),
  oppTeam('opp-rosenau-4', 'club-fftt-06680125', 4, 'div-3', 'group-3'),
  oppTeam('opp-soultz-2', 'club-fftt-06680138', 2, 'div-4', 'group-4'),
  oppTeam('opp-wittelsheim-5', 'club-fftt-06680118', 5, 'div-4', 'group-4'),
  oppTeam('opp-illzach-8', 'club-fftt-06680091', 8, 'div-4', 'group-4'),
  oppTeam('opp-fcm-3', 'club-fftt-06680006', 3, 'div-4', 'group-4'),
  oppTeam('opp-kembs-2', 'club-fftt-06680140', 2, 'div-4', 'group-4'),
  oppTeam('opp-ensisheim-1', 'club-fftt-06680123', 1, 'div-4', 'group-4'),
  oppTeam('opp-rosenau-6', 'club-fftt-06680125', 6, 'div-4', 'group-4'),
  oppTeam('opp-issenheim-3', 'club-fftt-06680071', 3, 'div-5', 'group-5'),
  oppTeam('opp-illzach-7', 'club-fftt-06680091', 7, 'div-5', 'group-5'),
  oppTeam('opp-ballons-4', 'club-fftt-06880064', 4, 'div-5', 'group-5'),
  oppTeam('opp-mutt-5', 'club-fftt-06680105', 5, 'div-5', 'group-5'),
  oppTeam('opp-wittelsheim-4', 'club-fftt-06680118', 4, 'div-5', 'group-5'),
  oppTeam('opp-wintzfelden-3', 'club-fftt-06680116', 3, 'div-5', 'group-5'),
  // Group 6 opponents (Equipe 7)
  oppTeam('opp-huningue-3', 'club-fftt-06680102', 3, 'div-6', 'group-6'),
  oppTeam('opp-mutt-7', 'club-fftt-06680105', 7, 'div-6', 'group-6'),
  oppTeam('opp-thann-5', 'club-fftt-06680111', 5, 'div-6', 'group-6'),
  oppTeam('opp-stlouis-3', 'club-fftt-06680082', 3, 'div-6', 'group-6'),
  oppTeam('opp-kembs-3', 'club-fftt-06680140', 3, 'div-6', 'group-6'),
  oppTeam('opp-illzach-10', 'club-fftt-06680091', 10, 'div-6', 'group-6'),
  oppTeam('opp-soultz-4', 'club-fftt-06680138', 4, 'div-6', 'group-6'),
  // Group 7 opponents (Equipe 8)
  oppTeam('opp-rosenau-7', 'club-fftt-06680125', 7, 'div-7', 'group-7'),
  oppTeam('opp-thann-4', 'club-fftt-06680111', 4, 'div-7', 'group-7'),
  oppTeam('opp-issenheim-4', 'club-fftt-06680071', 4, 'div-7', 'group-7'),
  oppTeam('opp-huningue-4', 'club-fftt-06680102', 4, 'div-7', 'group-7'),
  oppTeam('opp-kembs-6', 'club-fftt-06680140', 6, 'div-7', 'group-7'),
  oppTeam('opp-kembs-4', 'club-fftt-06680140', 4, 'div-7', 'group-7'),
  oppTeam('opp-illzach-11', 'club-fftt-06680091', 11, 'div-7', 'group-7'),
]
