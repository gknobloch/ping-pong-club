...
const baseClubs: Omit<Club, 'channels'>[] = [
  ...
  { id: 'club-etival', affiliationNumber: '06880123', displayName: 'Etival', isArchived: false, addresses: opponentAddr('addr-etival', 'Etival') },
  { id: 'club-rosenau', affiliationNumber: '06680125', displayName: 'Rosenau', isArchived: false, addresses: opponentAddr('addr-rosenau', 'Rosenau') },
  { id: 'club-rc-strasbourg', affiliationNumber: '06670045', displayName: 'RC Strasbourg', isArchived: false, addresses: opponentAddr('addr-rcs', 'Strasbourg') },
  { id: 'club-vittel', affiliationNumber: '06880022', displayName: 'Vittel St Remy', isArchived: false, addresses: opponentAddr('addr-vittel', 'Vittel') },
  { id: 'club-illzach', affiliationNumber: '06680091', displayName: 'Illzach', isArchived: false, addresses: opponentAddr('addr-illzach', 'Illzach') },
  { id: 'club-moussey', affiliationNumber: '06100004', displayName: 'Moussey', isArchived: false, addresses: opponentAddr('addr-moussey', 'Moussey') },
  { id: 'club-anould', affiliationNumber: '06880002', displayName: 'Anould', isArchived: false, addresses: opponentAddr('addr-anould', 'Anould') },
  ...
  { id: 'club-colmar-aje', affiliationNumber: '06680080', displayName: 'Colmar AJE', isArchived: false, addresses: opponentAddr('addr-caje', 'Colmar') },
  { id: 'club-saint-louis', affiliationNumber: '06680082', displayName: 'Saint-Louis', isArchived: false, addresses: opponentAddr('addr-stlouis', 'Saint-Louis') },
  { id: 'club-huningue', affiliationNumber: '06680102', displayName: 'Huningue', isArchived: false, addresses: opponentAddr('addr-huningue', 'Huningue') },
  { id: 'club-ingersheim', affiliationNumber: '06680090', displayName: 'Ingersheim', isArchived: false, addresses: opponentAddr('addr-ingersheim', 'Ingersheim') },
  { id: 'club-issenheim', affiliationNumber: '06680071', displayName: 'Issenheim', isArchived: false, addresses: opponentAddr('addr-issenheim', 'Issenheim') },
  { id: 'club-wintzfelden', affiliationNumber: '06680116', displayName: 'Wintzfelden', isArchived: false, addresses: opponentAddr('addr-wintzfelden', 'Wintzfelden') },
  { id: 'club-thann', affiliationNumber: '06680111', displayName: 'Thann', isArchived: false, addresses: opponentAddr('addr-thann', 'Thann') },
  { id: 'club-soultz', affiliationNumber: '06680138', displayName: 'Soultz', isArchived: false, addresses: opponentAddr('addr-soultz', 'Soultz') },
  { id: 'club-wittelsheim', affiliationNumber: '06680118', displayName: 'Wittelsheim', isArchived: false, addresses: opponentAddr('addr-wittelsheim', 'Wittelsheim') },
  { id: 'club-fc-mulhouse', affiliationNumber: '06680006', displayName: 'FC Mulhouse', isArchived: false, addresses: opponentAddr('addr-fcm', 'Mulhouse') },
  { id: 'club-kembs', affiliationNumber: '06680140', displayName: 'Kembs', isArchived: false, addresses: opponentAddr('addr-kembs', 'Kembs') },
  { id: 'club-ensisheim', affiliationNumber: '06680123', displayName: 'Ensisheim TTMC', isArchived: false, addresses: opponentAddr('addr-ensisheim', 'Ensisheim') },
  { id: 'club-ballons', affiliationNumber: '06880064', displayName: 'Ballons des Vosges', isArchived: false, addresses: opponentAddr('addr-ballons', 'Ballons des Vosges') },
  { id: 'club-mulhouse-tt', affiliationNumber: '06680105', displayName: 'Mulhouse TT', isArchived: false, addresses: opponentAddr('addr-mutt', 'Mulhouse') },
]
