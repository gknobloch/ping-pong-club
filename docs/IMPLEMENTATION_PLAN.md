...
| [**#4**](https://github.com/gknobloch/ping-pong-club/issues/4) | **Match-days and games** — Define match-days per phase (default 7 for 8-team group). Generate games (pairs of teams per match-day). Handle “exempt” when &lt; 8 teams. List/view match-days and games. | To do |
